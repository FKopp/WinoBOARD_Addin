...
#ifndef _VARIANT_WINO_
#define _VARIANT_WINO_
...
#define PIN_SPI_MISO         (PIN_A5)
#define PIN_SPI_MOSI         (PIN_A2)
#define PIN_SPI_SCK          (PIN_A3)
#define PERIPH_SPI           sercom0
#define PAD_SPI_TX           SPI_PAD_0_SCK_1
#define PAD_SPI_RX           SERCOM_RX_PAD_3

static const uint8_t SS	  = PIN_A4 ;	// SERCOM0 PAD[2] is present on A4 but HW SS isn't used. Set here only for reference.
...
#define PIN_WIRE_SDA         (PIN_A6)
#define PIN_WIRE_SCL         (PIN_A7)
